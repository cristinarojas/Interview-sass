...
module.exports = function(app) {
  ...
  personalitiesController = require('./controllers/personalities');
  ...
  app.use(function(req, res, next) {
    res.locals.currentPage = utils.getCurrentPage(req.url);
  ...
  app.use(function(req, res, next) {
    res.locals.css = [
      '/css/pages/' + res.locals.currentPage + '.css'
    ];
  ...
  app.use('/:language(' + availableLanguages + ')/personalities', personalitiesController);
  app.use('/:language(' + availableLanguages + ')/rules', rulesController);
